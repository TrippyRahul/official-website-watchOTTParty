    ...
    <div className={styles.about}>
      <div className={styles.container}>
        ...
        <div className={styles.bottom}>
          <p>
            Don't worry if have a long-distance relationship, still, <span>your
            friends watch online Hindi movies on Hulu.</span> with its sense of
            closeness and shared experience among individuals, it brings people
            closer together. Here, you can also <span>watch parties on Netflix.</span>
            Compared to the <span>teleparty extension</span> watch Ottparty, there are
            numerous features and options to enjoy your best movie experience
